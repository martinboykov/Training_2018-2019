...
// Source code: https://github.com/trekhleb/javascript-algorithms/tree/master/src/algorithms/graph/floyd-warshall

const Graph = require('../graphs.weighted.directed');
    ...
    vertices.forEach((endVertex, endIndex) => {
      if (startVertex === endVertex) {
        ...
        const edge = graph.list[startVertex].filter((v) => {
          return v.node.toString() === endVertex; // endVertex is a string, while v.node is a number
        })[0];
        // console.log(edge);
        if (edge) {
