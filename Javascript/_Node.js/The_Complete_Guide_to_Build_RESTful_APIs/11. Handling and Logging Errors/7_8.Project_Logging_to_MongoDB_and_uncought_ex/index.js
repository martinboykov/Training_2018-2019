...
winston.add(winston.transports.MongoDB, { db: 'mongodb://localhost/project-restful-api' });
...
// testing the error handling outside express middleware:
// throw new Error('Error outside express midleware test!'); // testing winston logger
