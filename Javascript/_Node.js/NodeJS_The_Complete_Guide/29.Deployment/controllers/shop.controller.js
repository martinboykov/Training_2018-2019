...
const getRedirectToFirstPage = async (req, res, next) => {
    res.redirect('/?page=1');
};
const getIndex = async (req, res, next) => {
    try {
        const products = await Product.find().limit(6).sort({ title: 1 });
        ...
        // const pages = paginationObj.pages || [1];
