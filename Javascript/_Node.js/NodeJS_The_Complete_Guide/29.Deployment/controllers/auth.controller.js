...
const options = {
    auth: {
        ...
        // api_key: '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', // from https://app.sendgrid.com/settings/api_keys
        api_key: `${process.env.SENDGRID_KEY}`, // from https://app.sendgrid.com/settings/api_keys
