...
export class PostService {
  ...
  getPosts(postsPerPage: number, currentPage: number) {
    ...
    this.http
      .get<{ message: string, posts: any }>(BACKEND_URL + queryParams)
  ...
  getTotalPostsCount() {
    return this.http.get<{ message: string, postsCount: number }>(BACKEND_URL+'totalCount');
  }
  ...
  updatePost(id: string, title: string, content: string, image: File | string) {
   ...
   return this.http
      .put<{ message: string, updatePost: any }>(BACKEND_URL + id, postData)
      // .subscribe(
      //   (responseData) => {
      //     console.log(responseData);
      //     this.router.navigate(['/']);
      ...
      //   (error) => {
      //     console.log(error);
      //     console.log(this.previousRouteService.getCurrentUrl());
      //     this.router.navigate([this.previousRouteService.getCurrentUrl()]);
